$(function () {
  ...
  $('.comment-list').delegate('a,input', 'click', function () {
    ...
    if (sClassValue.indexOf('reply_btn') >= 0) {
      ...
      let parents_id = $this.parent().attr('comment-id');
        ...
        .done(function (res) {
          ...
          <li class="comment-item">
            <div class="comment-info clearfix">
              ...
              <span class="comment-pub-time">${one_comment.parents_id.update_time}</span>
            </div>
            <div class="comment-content">${one_comment.content}</div>
                <div class="parent_comment_text">
                  <div class="parent_username">${one_comment.parents_id.author}</div>
                  <br/>
                  <div class="parent_content_text">
                    ${one_comment.parents_id.content}
                  </div>
                </div>
